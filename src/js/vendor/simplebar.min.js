...
!(function (t, e) {
      ...
      W('inspectSource', function (t) {
        ...
        (t.exports = function (t, e, n, o) {
          ...
          'function' == typeof n &&
            ...
            t !== a
              ? (s ? !l && t[e] && (c = !0) : delete t[e], c ? (t[e] = n) : C(t, e, n))
              : c
              ? (t[e] = n)
              : j(e, n);
  ...
  var Qt =
    ...
    re =
      ...
      function (t, e) {
        var r;
        return (
          null !== t ? ((te.prototype = R(t)), (r = new te()), (te.prototype = null), (r[Zt] = t)) : (r = ee()),
          void 0 === e ? r : Kt(r, e)
        );
      };
  H[Zt] = !0;
    ...
    Te = function (t, e, r, i, n, o, s) {
      ...
      if (
        (b &&
          ...
          Se !== Object.prototype &&
            a.next &&
            (de(a) !== Se && (we ? we(a, Se) : 'function' != typeof a[ke] && C(a, ke, Ae)), me(a, f, !0))),
        'values' == n &&
          v &&
          'values' !== v.name &&
          ((h = !0),
      ...
      return function (e, r) {
        ...
        return s < 0 || s >= a
          ? t
            ? ''
            : void 0
          : (i = o.charCodeAt(s)) < 55296 || i > 56319 || s + 1 === a || (n = o.charCodeAt(s + 1)) < 56320 || n > 57343
          ? t
            ? o.charAt(s)
            : i
          : t
  ...
  var Gr = function (t, e, r) {
      ...
      if ('function' != typeof t) throw new TypeError(Rr);
      return (
        $r(r) && ((i = 'leading' in r ? !!r.leading : i), (n = 'trailing' in r ? !!r.trailing : n)),
      ...
      return (
        Hi.some(function (t) {
          ...
          ('function' == typeof ErrorEvent
            ...
            : ((t = document.createEvent('Event')).initEvent('error', !1, !1), (t.message = qi)),
      ...
      return (
        ...
        (t.observe = function (t, e, r) {
          ...
          Tn(i.observationTargets, e) < 0 &&
            (n && Hi.push(i), i.observationTargets.push(new On(e, r && r.box)), Sn(1), wn.schedule());
        }),
        ...
        Array.prototype.forEach.call(t.addedNodes, function (t) {
          1 === t.nodeType &&
            (t.hasAttribute('data-simplebar')
              ? !lo.instances.has(t) && document.documentElement.contains(t) && new lo(t, io(t.attributes))
